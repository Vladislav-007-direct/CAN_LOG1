...
update_thread::update_thread(MainWindow * mw): _mw(mw) {
...
void update_thread::run() {
    ...
    disconnect(this, SIGNAL(conn()), _mw->_read_thread, SLOT(devconn()));
    connect(this, SIGNAL(conn()), _mw->_read_thread, SLOT(devconn()));


    disconnect(this, SIGNAL(disconn()), _mw->_read_thread, SLOT(devdisconn()));
    connect(this, SIGNAL(disconn()), _mw->_read_thread, SLOT(devdisconn()));
    ...
    if (a1_timer) delete a1_timer;
    if (a2_timer) delete a2_timer;
