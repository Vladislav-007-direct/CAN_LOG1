...
public:    
    ...
    QSpinBox* create_spin(bool readonly, QWidget *InfoCrane) {
    ...
    QDoubleSpinBox* create_ddspin(bool readonly, QWidget *InfoCrane) {
    ...
    QLineEdit* create_line_edit(bool readonly, QWidget *InfoCrane) {
    ...
    QDateEdit* create_calendar(bool readonly, QWidget *InfoCrane) {
    ...
    QDateTimeEdit* create_datetime(bool readonly, QWidget *InfoCrane) {
    ...
    void setupUi(QMainWindow *InfoCrane) {
        QWidget* _InfoCrane = new QWidget(InfoCrane);
        InfoCrane->setWindowTitle("Информация о кране");
        InfoCrane->setCentralWidget(_InfoCrane);
        ...
        QVBoxLayout* verticalLayout = new QVBoxLayout(_InfoCrane);
